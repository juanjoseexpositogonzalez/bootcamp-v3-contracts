...
contract Exchange {
    ...
    function fillOrder(
        ...
        // Prevent filling if msg.sender alredy has their tokens listed
        require(
    ...
    function _trade(
        ...
        // Execute the trade
        // Let the user who created the order (_user) get their tokens
        // msg.sender is the user filling the order
        ...
        // Give the requested to msg.sender, and minus token balance from
